<tr class="d-flex flex-nowrap">
    ...
    @stack('price_td_start')
        <td class="col-sm-3 text-right d-none d-sm-block">@money($item->price - 0, $document->currency_code, true)</td>
    @stack('price_td_end')
    ...
    @stack('total_td_start')
        <td class="col-xs-4 col-sm-3 text-right pr-5">@money($item->total - 0, $document->currency_code, true)</td>
    @stack('total_td_end')
</tr>
